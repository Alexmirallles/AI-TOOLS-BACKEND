...
def main():
    ...
    parser.add_argument("--pdf-file", type=str, help="Path to the PDF file to upload",default="/Users/user/Documents/Programming/Freelancing/Lahaverez/GithubProjects/chatpdf/ALGORITHM 2nd Assignment.pdf")
